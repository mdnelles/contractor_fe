            ...
            <Grid container spacing={2}>
               ...
               >
                  <div style={{ paddingTop: 25 }}>
                     <CuiboidFBLR
                        front={
                           <TileImg img={react} txt='Front End Engineering' />
                        }
                        right={<TileImg img={aws} txt='Cloud Computing' />}
                        back={
                           <TileImg
                              img={github}
                              txt='Continuous Integration (CI/CD)'
                           />
                        }
                        left={
                           <TileImg
                              img={postgres}
                              txt='Database Administration'
                           />
                        }
                        css={CuboidGlobal1}
                        body={undefined}
                  ...
                  <Card>
                     ...
                     <CardContent>
                        ...
                        <Typography variant='body2' color='text.secondary'>
                           ...
                           solutions on Javascript / Typescript frameworks to
                           help business.
                        </Typography>
                     </CardContent>
                     <CardActions>
               ...
               <Grid item xs={12} lg={6}>
                  <Card>
                     ...
                     <CardContent>
                        ...
                        <Typography variant='body2' color='text.secondary'>
                           Complete solutions from dashboards and Front End (FE)
                           branding to Back End (BE) programming and cloud
               ...
               <Grid item xs={12} lg={6}>
                  <ul className='a'>
                     ...
                     <li>
                        Centralize workflow with online customers - reach new
                        markets
                     </li>
                     <li>
                        Achieve the benefits of a web presence and a mobile app
